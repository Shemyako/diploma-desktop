...
namespace pesopolis
{
    public partial class Lessons : Form
    {
        ...
        // Изменение чекбокса. Собаки кинолога ли
        ...
        private void Lessons_Shown(object sender, EventArgs e)
        {
            ...
            lessons_list.Columns.Add("№", lessons_list.Width / 6, HorizontalAlignment.Left);
            lessons_list.Columns.Add("Дата", lessons_list.Width / 6, HorizontalAlignment.Left);
            lessons_list.Columns.Add("Собака", lessons_list.Width / 6, HorizontalAlignment.Left);
            lessons_list.Columns.Add("Тип занятия", lessons_list.Width / 6, HorizontalAlignment.Left);
            lessons_list.Columns.Add("Площадка", lessons_list.Width / 6, HorizontalAlignment.Center);
            lessons_list.Columns.Add("Телефон", lessons_list.Width / 6, HorizontalAlignment.Center);

            dogs_list.Columns.Add("№", dogs_list.Width / 4, HorizontalAlignment.Left);
            dogs_list.Columns.Add("Кличка", dogs_list.Width / 4, HorizontalAlignment.Left);
            dogs_list.Columns.Add("Порода", dogs_list.Width / 4, HorizontalAlignment.Left);
            dogs_list.Columns.Add("Телефон хозяина", dogs_list.Width / 4, HorizontalAlignment.Left);
